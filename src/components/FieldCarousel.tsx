  ...
  return (
    <div className="relative w-full h-[500px] overflow-hidden rounded-lg">
      ...
      {images.map((image, index) => (
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 z-20 bg-gradient-to-t from-sport-blue/90 to-transparent">
            ...
            <Button className="sport-button">Explore Fields</Button>
          </div>
        </div>
      ))}
      ...
      <Button
        variant="outline"
        size="icon"
        className="absolute top-1/2 left-4 z-30 bg-white/20 backdrop-blur-sm border-white/10 hover:bg-white/30"
      ...
      <Button
        variant="outline"
        size="icon"
        className="absolute top-1/2 right-4 z-30 bg-white/20 backdrop-blur-sm border-white/10 hover:bg-white/30"
        onClick={goToNext}
      >
